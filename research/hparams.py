...
def Hparams():
    ...
    parser.add_argument('--three_downsampling', type=bool, default=True)
    parser.add_argument('--use_pca', type=bool, default=True)

    #whole project
    parser.add_argument('--width', type=int, default=192, help='image width for input')
    parser.add_argument('--height', type=int, default=192, help='image height for input')
    ...
    #pca
    parser.add_argument('--pca_num', type=int, default=4, help='decide the num of images saved by PCA')
