...
def Hparams():
    ...
    parser.add_argument('--three_downsampling', type=bool, default=False)
    ...
    parser.add_argument('--data_mode', type=str, default='2D', help='2D,3D')
    ...
    parser.add_argument('--model_mode', type=str, default='UNet++', help='UNet++,UNet,UNet+pca, UNetpa')
